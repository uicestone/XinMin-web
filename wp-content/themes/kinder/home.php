...
<div class="_section_event flw">
	<div class="box_parallax flw">
		<div class="parallax"><img src="images/upload/slide4.jpg" alt="background feauted"></div>
	</div>
<!--	-->
				...
				<div class="col-md-8 col-lg-8 sss">
					<div class="event_cs">
						<div class="event_item">
							<div class="box_img">
								<img src="images/upload/babe1_2.png" alt="">
								<div class="shape"></div>
							</div>
						...
						<div class="event_item">
							<div class="box_img">
								<img src="images/upload/event.png" alt="">
								<div class="shape"></div>
							</div>
							<div class="event_content">
